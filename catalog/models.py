...
class Genre(models.Model):
    ...
    name = models.CharField(max_length=200,help_text="Enter a book genre(e.g. Politics)")
...
class Language(models.Model):
    language = models.CharField(max_length=50,help_text='Enter the language of the book.')
...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=1000,help_text="Enter a brief description here.")
